...
<head>
    ...
    <title>Report Bulk Absensi Tropmed</title>
    <style>
        /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                            ...
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>Hai di sana,</p>
                                            <p>Ini adalah email download report absensi</p>
                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">Tropmed Company Inc, Universitas Gadjah Mada</span>
                            ...
                            <tr>
                                <td class="content-block powered-by">
                                    Powered by <a href="http://naufalols.github.io">BITIND</a>.
                                </td>
                            </tr>
                        </table>
                    </div>
