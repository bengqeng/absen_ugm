        ...
        <div class="row">
            <div class="col my-4">
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.project.index') }}" class="btn btn-lg btn-outline-success px-4 d-block rounded-4"
                    ...
                    <a href="{{ route('admin.user.index') }}" class="btn btn-lg btn-outline-success px-4 d-block rounded-4"
                       style="text-align:left;" type="
                                                    button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <button class="btn btn-lg btn-outline-warning px-4 d-block rounded-4" style="text-align:left;"
                            type="
                                                    button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a class="btn btn-lg btn-outline-danger rounded-4 px-4" href="{{ route('auth.logout') }}" style="text-align:left;"
                            type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
