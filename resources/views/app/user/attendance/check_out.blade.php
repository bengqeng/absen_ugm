...
<div class="container mt-3">
    <div class="row">
        <div class="col-12 mb-3 text-center">
            ...
            <span
                class="badge text-uppercase rounded-pill text-bg-{{ $statusIp === 'out office' ? 'secondary' : 'success' }}">{{
                $statusIp }}</span>
        </div>
        <div class=" col-12">
            @if ($errors->any())
            ...
            <form action="{{ route('staff.checkout.store') }}" method="POST">
                ...
                <div class="mx-2">
                    ...
                    <div class="p-3 border bg-default mb-2 rounded-2">
                        Absensi Check In, pukul <span class="fw-bolder">{{$recent_hours_checkin}}</span>
                    </div>
                    <div class="p-3 border bg-default mb-2 rounded-2">
                        Hari ini, {{ now()->format('j F Y') }}, pukul <span class="fw-bolder" id="time"></span>
                    </div>
                    <hr>
                    <div class="form-floating mb-2 bg-white">
                    ...
                    <div class="form-floating mb-2 bg-white">
                        <textarea class="form-control" name="note_overtime" placeholder="Deskripsi Lembur:"
                            id="floatingTextareanoteovertime" style="height: 100px"></textarea>
